...
const attorney = {
  ...
  bio: "Ilyas Amin is a distinguished Advocate of the High Court with a proven track record in complex litigation. His strategic approach and thorough legal analysis have secured landmark victories for his clients across multiple practice areas.",
};
